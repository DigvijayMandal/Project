        ...
        <div class="container py-lg-5 py-md-4 py-2">
            ...
            <?php foreach ($product_shuffle as $item) { ?>
                <div class="col-lg-4 col-md-6 listing-img mt-5 pt-md-2">
                    <a href="<?php printf('%s?item_id=%s', 'product3.php',  $item['item_id']); ?>">
                        <div class="box16">
            ...
            <div class="pagination-wrapper mt-5 pt-lg-3 text-center">
                <ul class="page-pagination">
                    <li><a class="next" href="./listing2.php"> <span class="fa fa-angle-left"></span> Prev</a></li>
                    <li><a class="page-numbers" href="#">..</a></li>
                    <li><a class="page-numbers" href="./listing2.php">3</a></li>
                    <li><span aria-current="page" class="page-numbers current">4</span></li>
                    <li><a class="page-numbers" href="./listing4.php">5</a></li>
                    <li><a class="page-numbers" href="#url">6</a></li>
                    <li><a class="next" href="./listing4.php">Next <span class="fa fa-angle-right"></span></a></li>
                </ul>
            </div>
            <!-- //pagination -->
        </div>
