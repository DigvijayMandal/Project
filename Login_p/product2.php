          ...
          <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
              <ul class="navbar-nav ml-lg-5 mr-auto">
                  ...
                  <li class="nav-item @@listing__active">
                      <a class="nav-link" href="listing.php">Locations</a>
                  </li>
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="../Login/welcome.php">My Acoount</a>
                </li>
              </ul>
    ...
    <div class="container py-lg-4 py-md-3 py-2">
        <div class="inner mb-4">
            <ul class="blog-single-author-date align-items-center">
                <li>
                    <div class="listing-category"><span>Buy</span></div>
                </li>
                ...
                <div class="blog-single-post">
                    <div class="single-post-image mb-5">
                        <div class="owl-blog owl-carousel owl-theme">
                            <div class="item">
                                <div class="card">
                                    <img src="<?php echo $item['pic'] ?>" class="img-fluid radius-image" alt="image">
                                </div>
                            </div>
                        </div>
                    </div>
