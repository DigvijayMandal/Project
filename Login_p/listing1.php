          ...
          <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
              <ul class="navbar-nav ml-lg-5 mr-auto">
                  ...
                  <li class="nav-item active">
                      <a class="nav-link" href="listing.php">Loactions</a>
                  </li>
                  <li class="nav-item dropdown @@pages__active">
                      ...
                      <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                          <a class="dropdown-item @@about__active" href="about.php">About us</a>
                          <a class="dropdown-item @@contact__active" href="contact.php">Contact us</a>
                      </div>
                  </li>
                  <li class="nav-item">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="../Login/welcome.php">My Account</a>
                </li>
              </ul>
...
<section class="w3l-breadcrumb">
    <div class="container">
        <ul class="breadcrumbs-custom-path">
            ...
            <li class="active"><span class="fa fa-angle-right mx-2" aria-hidden="true"></span> Locations</li>
        </ul>
    </div>
</section>
        ...
        <div class="container py-lg-5 py-md-4 py-2">
            ...
            <?php foreach ($product_shuffle as $item) { ?>
                <div class="col-lg-4 col-md-6 listing-img mt-5 pt-md-2">
                    <a href="<?php printf('%s?item_id=%s', 'product1.php',  $item['item_id']); ?>">
                        <div class="box16">
                    ...
                    <div class="listing-details blog-details align-self">
                        ...
                        <p class="user_position"><?php echo $item['block'] ; ?> <?php echo $item['lot']; ?>, <?php echo $item['street_number']; ?>, <?php echo $item['street_name']; ?>, <?php echo $item['zipcode']; ?></p>
            ...
            <div class="pagination-wrapper mt-5 pt-lg-3 text-center">
                <ul class="page-pagination">
                    <li><a class="next" href="./listing.php"> <span class="fa fa-angle-left"></span> Prev</a></li>
                    <li><a class="page-numbers" href="./listing.php">1</a></li>
                    <li><span aria-current="page" class="page-numbers current">2</span></li>
                    <li><a class="page-numbers" href="./listing2.php">3</a></li>
                    <li><a class="page-numbers" href="#url">...</a></li>
                    <li><a class="page-numbers" href="./listing5.php">6</a></li>
                    <li><a class="next" href="./listing2.php">Next <span class="fa fa-angle-right"></span></a></li>
                </ul>
            </div>
            <!-- //pagination -->
        </div>
