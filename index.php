  ...
  <div class="container">
      <nav class="navbar navbar-expand-lg stroke px-0">
          <h1> <a class="navbar-brand" href="index.php">
                  <span class="fa fa-car"></span> Infinix Gaming
              </a></h1>
			...
			<div class="container">
				<div class="middle-section text-center">
					<div class="section-width">
						<p>Stand amongst the ashes of a trillion dead souls and ask the ghosts if honor matters. The silence is your answer.!</p>
						<h2>Find your game here.</h2>
						<div class="most-searches">
							<h4>Most Searches</h4>
							<ul>
								<li><a href="#link">Action</a></li>
								<li><a href="#link">Adventure</a></li>
								<li><a href="#link">Fantasy</a></li>
							</ul>
						</div>
    ...
    <div class="locations py-5">
        <div class="container py-lg-5 py-md-4 py-2">
            <div class="heading text-center mx-auto">
                <h3 class="title-big">Top Games</h3>
            </div>
                    ...
                    <a href="property-single.html">
                        <div class="box16">
                            ...
                            <div class="box-content">
                                ...
                                <span class="post">Assians Creed</span>
                            </div>
                        </div>
                    </a>
                </div>
                <div class="col-lg-4 col-md-6 mt-md-0 mt-4">
                    <a href="property-single.html">
                        <div class="box16">
                            ...
                            <div class="box-content">
                                <h3 class="title">$370</h3>
                                <span class="post">PUBG</span>
                ...
                <div class="col-lg-4 col-md-6 mt-lg-0 pt-lg-0 mt-4 pt-md-2">
                    <a href="property-single.html">
                        <div class="box16">
                            ...
                            <div class="box-content">
                                <h3 class="title">$410</h3>
                                <span class="post">Mass effect Andromeda</span>
                ...
                <div class="col-lg-4 col-md-6 mt-4 pt-md-2">
                    <a href="property-single.html">
                        <div class="box16">
                            ...
                            <div class="box-content">
                                <h3 class="title">$190</h3>
                                <span class="post">Tomb rider</span>
                ...
                <div class="col-lg-4 col-md-6 mt-4 pt-md-2">
                    <a href="property-single.html">
                        <div class="box16">
                            ...
                            <div class="box-content">
                                <h3 class="title">$2600</h3>
                                <span class="post">Need For Speed </span>
                ...
                <div class="col-lg-4 col-md-6 mt-4 pt-md-2">
                    <a href="property-single.html">
                        <div class="box16">
                            ...
                            <div class="box-content">
                                <h3 class="title">$340</h3>
                                <span class="post">NFS Most Wanted</span>
                            </div>
                        </div>
                    </a>
                </div>
...
<section class="locations-1 popular" id="locations">
    <div class="locations py-5">
        <div class="container py-lg-5 py-md-4">
            <div class="heading text-center mx-auto">
                <h6 class="title-small">Explore Games</h6>
                <h3 class="title-big">Popular Games</h3>
            </div>
            <div class="row pt-5">
                <div class="col-lg-3 col-md-4 col-6">
                    <a href="#url">
                        <div class="box16">
                            <img class="img-fluid" src="assets/images/g1.jpg" alt="">
                            <div class="box-content">
                                <h3 class="title mb-1">Assians Creed</h3>
                            </div>
                        </div>
                    </a>
                </div>
                ...
                <div class="col-lg-3 col-md-4 col-6 mt-md-0 pt-md-0 mt-sm-4 mt-3 pt-md-2">
                    <a href="#url">
                        <div class="box16">
                            <img class="img-fluid" src="assets/images/g3.jpg" alt="">
                            <div class="box-content">
                                <h3 class="title mb-1">Mass effect Andromeda</h3>
                ...
                <div class="col-lg-3 col-md-4 col-6 mt-lg-0 pt-lg-0 mt-sm-4 mt-3 pt-md-2">
                    <a href="#url">
                        <div class="box16">
                            <img class="img-fluid" src="assets/images/g4.jpg" alt="">
                            <div class="box-content">
                                <h3 class="title mb-1">Tomb Rider</h3>
                ...
                <div class="col-lg-3 col-md-4 col-6 mt-sm-4 mt-3 pt-md-2">
                    <a href="#url">
                        <div class="box16">
                            <img class="img-fluid" src="assets/images/g5.jpg" alt="">
                            <div class="box-content">
                                <h3 class="title mb-1">Need For Speed</h3>
                            </div>
                        </div>
                    </a>
                </div>
                <div class="col-lg-3 col-md-4 col-6 mt-sm-4 mt-3 pt-md-2">
                    <a href="#url">
                        <div class="box16">
                            <img class="img-fluid" src="assets/images/g6.jpg" alt="">
                            <div class="box-content">
                                <h3 class="title mb-1">NFS Most Wanted</h3>
                            </div>
                        </div>
                    </a>
                </div>
                <div class="col-lg-3 col-md-4 col-6 mt-sm-4 mt-3 pt-md-2">
                    <a href="#url">
                        <div class="box16">
                            ...
                            <div class="box-content">
                                <h3 class="title mb-1">Froza Horizon 5</h3>
                            </div>
                        </div>
                    </a>
                </div>
                <div class="col-lg-3 col-md-4 col-6 mt-sm-4 mt-3 pt-md-2">
                    <a href="#url">
                        <div class="box16">
                            ...
                            <div class="box-content">
                                <h3 class="title mb-1">Final Fantasy VII</h3>
                            </div>
                        </div>
                    </a>
                </div>
